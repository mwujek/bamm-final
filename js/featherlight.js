	...
	*/
	...
	function Featherlight($content, config, titleIndex, infoIndex) {
		...
		if(this instanceof Featherlight) {  /* called with new */
			...
			var fl = new Featherlight($content, config, titleIndex, infoIndex);
			fl.open();
			return fl;
		}
	}
	...
	Featherlight.prototype = {
					...
					'<div class="'+css+'">',
						'<div class="'+css+'-content">',
							'<span class="'+css+'-close-icon '+ self.namespace + '-close">',
								self.closeIcon,
							'</span>',
							'<div class="videoInfo"><h1>'+self.artistName+'</h1><p>'+self.artistInfo+'</p></div>',
		...
		setContent: function($content){
			...
			//var titleCopy= ["artist1", "artist2"];
			//var infoCopy=["This is so good!","idk"];
			//$('.videoInfo p').text( titleCopy[0]);
